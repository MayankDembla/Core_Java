...
public class ArraysClassDemo {
    ...
    private static void sequential() {
        ...
        // asList - most commonly used method
        // List<T> asList(T...)
        ...
        strings.set(0, "Anubhooti");
        System.out.println(Arrays.toString(strArray));

        // Creating Modifiable ArrayList from the Array
        ...
        // list of size 3 with null value - Fixed Size ArrayList
        List<String> fixedList = Arrays.asList(new String[3]);

        // Recall that arrays are not auto-boxable
//        List<Integer> test = Arrays.asList(new int[3]) ;
        List<Integer> test = Arrays.asList(new Integer[3]);

        // this will work fine.
        List<int[]> testi = Arrays.asList(new int[4]);
        System.out.println(testi.size());
    }


    private static void arraysortop() {
