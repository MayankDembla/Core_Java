...
public class CollectionsClassDemo {
    ...
    private static void collectionsClassDemo() {
        ...
        // list.addAll(Arrays.asList(array)) -- this is slower
        ...
        Collections.sort(list); // Natural Ordering Sort
        // Another version is Comparator as a input.


        // Binary Search
        //

        Book b = new Book("HeadFirst",45) ;
        Set<Book> books = Collections.singleton(b) ;

       b.setId(46); // Can Change the state of the Object i.e. mutable

        // Can't Change the state of this object as it becomes immutable
       //books.add(new Book("Harry Potter" , 56)) ;
        System.out.println(books);

       // Unmodifiable Collection - Composition and forwarding pattern
       Collection<String> books1 = Collections.unmodifiableCollection(list) ;
       list.add("jdf") ;
       // Unsupported Exception.
       // changeSomething(books1);
    ...
    private static void changeSomething(Collection<String> str){
        str.add("Changed") ;
